...
troll(){
    ...
    echo "   !         !                               !  " | lolcat
    sleep 0.03
    echo "    \_______/________________                !  " | lolcat
    sleep 0.03
    echo "                            !        !      !   " | lolcat
    sleep 0.03
...
mulai (){
    echo "Gunakan KNTL Project Lagi?"
    echo "y/n?"
    echo
    read lagi
    if [ $lagi = "y" ]; then
            ...
            echo "Terimakasih sudah menggunakan KNTL project"
    fi
}
#spam
spam(){
...
clear
troll
echo Selamat datang kak, Siapa kekasih kakak? #tulisan keluar
read kekasih #membaca yang ditulis
clear
troll
echo Selamat datang $kekasih ":)"
echo
echo "Mulai KNTL project?"
echo "y/n?"
read mulai
if [ $mulai = "y" ]; then
      spam
